        ...
        "documents": [
            {
                ...
                "filename": d.filename,
                "format": d.format,
                "s3_url": f"/api/v1/uploads/{(d.local_url or d.s3_url or '').split('/')[-1] or d.filename}",
                "raw_s3_url": d.s3_url,
                "local_url": d.local_url or f"/api/v1/uploads/{(d.s3_url or '').split('/')[-1] or d.filename}",
...
def get_document_chunks(
    ...
    return {
        ...
        "document": {
            ...
            "format": doc.format,
            "s3_url": f"/api/v1/uploads/{(doc.local_url or doc.s3_url or '').split('/')[-1] or doc.filename}",
