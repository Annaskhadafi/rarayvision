...
from app.services.tire_ocr.config import TireExtractionConfig
from app.services.tire_ocr.schemas.tire_info import TireInfo
from app.services.tire_ocr.services.gemini import extract_tire_information, extract_tire_information_raw
from app.services.tire_ocr.models.text_recognition import TextRecognitionModel
from app.services.tire_ocr.models.text_detection import TextDetectionModel
from app.services.tire_ocr.utils.image_preprocessing import preprocess_image
from app.services.tire_ocr.utils.tire_cropping import detect_tire_and_rim, get_flattened_sidewall_image
from app.services.tire_ocr.pipeline.types import TextDetectionResult, PipelineResult, PipelineStepEvent
from app.services.tire_ocr.exceptions import (
    ImageLoadError,
    TireDetectionError,
