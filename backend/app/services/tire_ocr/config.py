...
class TireExtractionConfig:
    ...
    MODEL_DIR = os.path.join(BASE_DIR, "ml_models", "tire_sidewall")
    
    YOLO_MODEL_PATH = os.path.join(MODEL_DIR, "tire_det.pt")
    TEXT_DETECTION_MODEL_PATH = os.path.join(MODEL_DIR, "yolov11n_oclip_asp_c5.pt")
    TEXT_RECOGNITION_MODEL_PATH = os.path.join(MODEL_DIR, "text_rec.pth")

    # Benchmark: additional text detector for comparison
    TEXT_DETECTION_ORIGIN_MODEL_PATH = os.path.join(MODEL_DIR, "yolo_origin.pt")
    TEXT_DETECTION_IMPROVED_MODEL_PATH = os.path.join(MODEL_DIR, "yolov11n_oclip_asp_c4_sppf2.pt")
