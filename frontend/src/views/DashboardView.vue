...
const copyUrl = () => {
  navigator.clipboard.writeText('https://vision.chitraparatama.com/api/v1')
      ...
      <div class="webhook-content">
        ...
        >
          <div>
            ...
            <p style="margin: 0.5rem 0 0 0; font-family: monospace; font-size: 1rem; color: #0f172a; font-weight: 600; word-break: break-all;">https://vision.chitraparatama.com/api/v1</p>
          </div>
